...
class ReflectUtilsTests {
    ...
    @Test
    void getPropertyDescriptorShouldReturnNullIfMissingByClass() {
        PropertyDescriptor pd = ReflectUtils.getPropertyDescriptor(Person.class, "unknown");
        assertNull(pd);
    }
    ...
    @Test
    void getPropertyDescriptorShouldReturnNullIfMissingByBeanInfo() throws IntrospectionException {
        BeanInfo info = Introspector.getBeanInfo(Person.class);
